...
int main()
{
    heada = createadmin(heada,1,"Dal Tadka\t",100);
    heada = createadmin(heada,2,"Paneer Butter ",200);
    heada = createadmin(heada,3,"Dal khichadi",150);
    heada = createadmin(heada,4,"Fried Rice\t",80);
    heada = createadmin(heada,5,"Veg Kolhapuri",120);
